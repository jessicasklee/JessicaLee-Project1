...
const questionone = "Which broadway won Best Musical?"
const answer1 = "The Band's Visit"
const answer2 = "Frozen"
const answer3 = "Mean Girls"

enter.addEventListener('click', openquestion);

function openquestion() {
    console.log('button is working!');
    // let paragraph = document.createElement('p')
    let question = document.createTextNode(questionone)
    document.querySelector('.question').appendChild(question);
    let answers = document.createTextNode(answer1, answer2, answer3)
    document.querySelector('.answers').appendChild(answers);
}
...
//     evt.preventDefault();
//     document.getElementByClassName("question-page").createTextNode('q1')
// }
